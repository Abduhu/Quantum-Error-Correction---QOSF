...
1. Build the following simple circuit to prepare the Bell state: ![\Large (|0\rangle + |1\ramgle)/\sqrt{2}](https://latex.codecogs.com/svg.latex?\Large&space;(|0\rangle + |1\ramgle)/\sqrt{2}) 
